...
<!--
   ...
   If you must edit this file, Norm *MUST* know.

   2007-01-16:  MSM edited the file to wrap the word 'errata' in
   a 'strong' element and add the word 'some'.  Pub rules seems to like
   it that way.
   MSM could not be bothered to figure out how to fix it correctly.
...
<!-- xmlspec.xsl: An HTML XSL[1] Stylesheet for XML Spec V2.1[2] markup
     ...
     Version: $Id: xmlspec.xsl,v 1.51 2005/01/27 15:11:32 NormanWalsh Exp $
     ...
     Date:    Created 07 September 1999
              Last updated $Date: 2005/01/27 15:11:32 $ by $Author: NormanWalsh $
...
<!--
  ...
  <xsl:template match="errataloc">
    <p>
      ...
      include some normative corrections.</xsl:text>
    </p>
  </xsl:template>
